...
`encrypt_decrypt` function that handles both directions by negating the key for decryption. This is a great 
beginner project for understanding character manipulation, indexing, and modular arithmetic in Python.
